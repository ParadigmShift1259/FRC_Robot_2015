...
private:
	...
	double levels[7] = {floorHeight,toteHeight,coopStep,coopStep+toteHeight,coopStep+2*toteHeight,coopStep+3*toteHeight, scoringPlatform}; //inches floor,scoring platform, step, step+tote, step+2totes, step+3totes,tote
public:
